...
from server.oldsrc.core.settings import ASSETS_ROUTER_PREFIX, GAMES_ASSETS_PATH, GAMES_ASSETS_HEADER_DIR, \
...
from server.oldsrc.core.utils.io import clear, save, read_uncompressed_chunks, CHUNK_SIZE
